 ...
 * TODO: reemplazar BINANCE_PAY_ID por el ID real de Leo Hub cuando esté disponible.
 */
export const BINANCE_PAY_ID = "TU-BINANCE-ID";
export const BINANCE_PAY_NAME = "Leo Hub";
export const BINANCE_PAY_CURRENCY = "USDT";

export const PAYMENT_STEPS: string[] = [
  "Abre Binance y ve a Pay / Pagar.",
  "Ingresa el Binance ID de Leo Hub (o escanea su QR).",
